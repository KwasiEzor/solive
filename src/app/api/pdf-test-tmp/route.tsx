...
// Temporary diagnostic route (fake data only, no auth, no DB) to verify the
// PDF render pipeline in production without needing a session. Deleted after
// use — see the "PDF génération" fix in this session's history.
